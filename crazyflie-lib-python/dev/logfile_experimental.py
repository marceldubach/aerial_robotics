...
class LoggingExample:
    ...
    def _connected(self, link_uri):
        ...
        self._lg_stab.add_variable('stabilizer.thrust','float') # added thrust

        # Add position values
        self._lg_state_est = LogConfig(name='StateEstimate',period_in_ms=10)
        self._lg_state_est.add_variable('state_est.x','float')
        self._lg_state_est.add_variable('state_est.y','float')
        self._lg_state_es.add_variable('state_est.z','float')
